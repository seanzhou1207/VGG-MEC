...
from mec import *
class VGG11_configuration_D(nn.Module):
    def __init__(self,in_channels,num_classes=10):
        super(VGG11_configuration_D,self).__init__()
...
if __name__ == "__main__":
    ...
    model = VGG11_configuration_D(in_channels=1,num_classes=10)
    ...
    with open('model_5_metrics.txt', 'w') as f:
