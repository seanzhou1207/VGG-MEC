...
if __name__ == "__main__":
    ...
    num_hidden_layers = [64,128,256,512,1024,2048,4096,8191]
    train_accuracy_all = []
    test_accuracy_all = []
    mec_ffnn_all = []
    ...
    plt.plot(mec_ffnn_all, train_accuracy_all, marker='o', linestyle='-', color='r')
    plt.xlabel('MEC')
    ...
    plt.figure(figsize=(10, 5))
    plt.plot(mec_ffnn_all, test_accuracy_all, marker='o', linestyle='-', color='r')
    plt.xlabel('MEC')
    ...
    # with open('model_1_metrics.txt', 'w') as f:
