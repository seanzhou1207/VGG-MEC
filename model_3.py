...
if __name__ == "__main__":
    ...
    model = VGG11_configucration_B(in_channels=1,num_classes=10)
    ...
    train_losses, test_losses = train_test_epochs(model, trainloader, testloader, epochs=5, lr=1e-2, device=device)
    ...
    with open('model_3_metrics.txt', 'w') as f:
